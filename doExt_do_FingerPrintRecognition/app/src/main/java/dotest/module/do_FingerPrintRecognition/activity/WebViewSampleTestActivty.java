...
import doext.module.do_FingerPrintRecognition.implement.do_FingerPrintRecognition_Model;
...
public class WebViewSampleTestActivty extends DoTestActivity {
	...
	protected void initModuleModel() throws Exception {
		this.model = new do_FingerPrintRecognition_Model();
	}
	...
	protected void doTestAsyncMethod() {
		...
		DoService.asyncMethod(this.model, "startRecognize", _paras_loadString, new DoService.EventCallBack() {
			@Override
